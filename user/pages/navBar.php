                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    ...
                                    <a href="#"><i class="fa fa-users fa-fw"> </i>  Operadores </a>
                                </li>
                                <li> <!-- fa-fw para manter tamanho do icone-->
                                    <a href="clientes.php"> <i class="fa fa-user fa-fw"> </i> Clientes </a>
                                </li>
                                <li>
                                    <a href="processos.php"> <i class="fa fa-briefcase fa-fw"></i> Processos </a>
                                </li>

                                <li>
                                    <a href="#"> <i class="fa fa-briefcase fa-fw"></i> Modelos de processos </a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                   <a href="#"> <i class="fa fa-building fa-fw"></i> Contas a receber </a>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-users fa-fw"> </i>  Contas a pagar </a>
                                </li>
                                <li> <!-- fa-fw para manter tamanho do icone-->
                                    <a href="#"> <i class="fa fa-user fa-fw"> </i> Movimentação financeira </a>
                                </li>
                            </ul>
                        </li>
                        <li>
